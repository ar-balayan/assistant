...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapHometodayContainer(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapChoice(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.choiceScreen);
  }

  onTapHometodayContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.homeTodayContainerScreen);
  }

  onTapHomeWEEK(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.homeWeekScreen);
  }

  onTapHomeMonthOne(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.homeMonthOneScreen);
  }

  onTapVitaminD(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.vitaminDScreen);
  }

  onTapSchedulethedose(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.scheduleTheDoseScreen);
  }

  onTapCalendar8(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.calendar8Screen);
  }

  onTapAddNewEvent(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.addNewEventScreen);
  }

  onTapHomeMonth(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.homeMonthScreen);
  }
}
